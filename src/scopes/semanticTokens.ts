...
export default function semanticTokens(
  ...
  return {
    ...
    namespace: { foreground: theme.colors.green },
    // parameter: { foreground: theme.colors.pink }, // original
    parameter: { foreground: theme.ui.editorForeground },
    property: { foreground: theme.colors.orange },
    "property.declaration": { foreground: theme.ui.editorForeground },
