...
export default function syntax(
  ...
  return Object.assign([
    ...
    createScope(prog.currentText, theme.ui.editorForeground),
    ...
    createScope(prog.objectProperty, theme.ui.editorForeground),
    createScope(prog.dataProperty, theme.colors.yellow),
    createScope(prog.operators, theme.colors.turquoize),
    createScope(
      prog.punctuation,
      hc ? theme.ui.editorForeground : c(theme.ui.editorForeground).alpha(0.4).toHex(),
    ),

    createScope(prog.self, theme.colors.orange),
    createScope(prog.storages, theme.colors.turquoize),
    createScope(prog.storagesAlt, theme.colors.yellow),
    ...
    createScope(prog.typesAlt, theme.colors.greenAlt),
    createScope(prog.variables, theme.colors.salmon),

    // ELM
    createScope(prog.typeConstructor, theme.colors.pink),
    createScope(prog.type, theme.colors.purple),

    // MARKUP
    createScope(markup.component, theme.colors.turquoize),
    // createScope(markup.component, theme.colors.purple), // original
    ...
    createScope(markup.attributes, theme.colors.blue),
    // createScope(markup.attributes, theme.colors.yellow), // original
    ...
    createScope(styling.units, theme.colors.red),
    createScope(styling.value, theme.colors.yellow),
    createScope(styling.nums, theme.colors.red),
