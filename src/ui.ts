...
export default function ui(
  ...
  const breadcrumbColors: BreadcrumbColors = {
    ...
    "breadcrumb.foreground": c(theme.ui.foreground)
      .alpha(0.8)
      .toHex(),
  ...
  const buttonColors: ButtonColors = {
    "button.background": c(theme.ui.primary).alpha(0.8).toHex(),
    "button.border": light
      ? c("#000000").alpha(0.15).toHex()
      : c("#FFFFFF").alpha(0.15).toHex(),
    "button.foreground": light
      ? c(theme.ui.primary).darken(0.5).alpha(0.8).toHex()
      : c(theme.ui.primary).lighten(0.5).alpha(0.8).toHex(),
  ...
  const editorColors: EditorColors = {
    ...
    "editor.lineHighlightBorder": createSelectionColor(0.1),
    ...
    "editorInlayHint.parameterBackground": c(theme.ui.defaultMain)
      .alpha(0.1)
      .toHex(),
    "editorInlayHint.parameterForeground": c(theme.ui.foreground)
      .alpha(0.7)
      .toHex(),
    "editorInlayHint.typeBackground": c(theme.ui.foreground)
      .alpha(0.1)
      .toHex(),
    "editorInlayHint.typeForeground": c(theme.ui.foreground)
      .alpha(0.7)
      .toHex(),
    "editorLineNumber.activeForeground": c(theme.ui.editorForeground).toHex(),
    "editorLineNumber.foreground": c(theme.ui.editorForeground)
    ...
    "editorUnnecessaryCode.border": hc
      ? c(theme.ui.foreground).alpha(0.6).toHex()
      : transparent,
  ...
  const inputColors: InputColors & InputOptionColors & InputValidationColors = {
    ...
    "inputValidation.errorBorder": theme.levels.danger,
    "inputValidation.infoBackground": theme.ui.primaryalt,
    "inputValidation.infoBorder": theme.levels.info,
    "inputValidation.warningBackground": theme.ui.primaryalt,
    "inputValidation.warningBorder": theme.levels.warning,
  };
  ...
  const notificationColors: NotificationsColors = {
    ...
    "notificationLink.foreground": theme.ui.primary,
  ...
  const progressBarColors: ProgressBarColors = {
    "progressBar.background": theme.ui.primary,
  };
  ...
  const quickInputColors: QuickInputColors = {
    ...
    "quickInputList.focusBackground": c(theme.ui.primary).alpha(0.1).toHex(),
    ...
    "quickInputList.focusForeground": light
      ? c(theme.ui.primary).darken(0.8).desaturate(0.1).toHex()
      : c(theme.ui.primary).lighten(0.8).desaturate(0.1).toHex(),
  ...
  const sideBarColors: SideBarColors = {
    ...
    "sideBar.foreground": c(theme.ui.foreground).alpha(0.8).toHex(),
  ...
  const tabColors: TabColors = {
    ...
    "tab.hoverBackground": light ? c(theme.ui.uibackground).darken(0.06).toHex() : c(theme.ui.uibackground).lighten(0.06).toHex(),
    "tab.inactiveBackground": theme.ui.uibackgroundalt,
    "tab.inactiveForeground": c(theme.ui.foreground)
  ...
  const terminalColors: TerminalColors = {
    ...
    "terminalCursor.foreground": theme.ui.primary,
